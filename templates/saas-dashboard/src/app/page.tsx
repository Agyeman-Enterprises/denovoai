    ...
    <div className="min-h-screen bg-[#0A0A0F]">
      <nav className="flex items-center justify-between px-6 py-4" style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/auth/login" className="rounded-lg px-4 py-2 text-sm font-semibold text-white" style={{ background: "#3B82F6" }}>
            {"{{CTA_PRIMARY}}"}
          </Link>
        </div>
      </nav>
      ...
      <section className="px-6 py-24 text-center">
        ...
        <Link href="/auth/login" className="mt-8 inline-block rounded-lg px-8 py-3 font-semibold text-white" style={{ background: "#3B82F6" }}>
