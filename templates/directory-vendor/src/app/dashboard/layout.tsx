    ...
    <div className="min-h-screen bg-[#0A0A0F] flex">
      <aside className="w-56 shrink-0 px-4 py-6" style={{ borderRight: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        <div className="mt-8 pt-4" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <Link href="/submit" className="block rounded-lg px-3 py-2 text-sm text-violet-400 hover:text-violet-300">Submit New</Link>
          <Link href="/browse" className="block rounded-lg px-3 py-2 text-sm text-white/25 hover:text-white/50">Browse Directory</Link>
        </div>
