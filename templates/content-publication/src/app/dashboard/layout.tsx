    ...
    <div className="min-h-screen bg-[#0A0A0F] flex">
      <aside className="w-56 shrink-0 px-4 py-6" style={{ borderRight: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        <nav className="space-y-1">
          {[
            { label: "Reading History", href: "/dashboard" },
        ...
        <div className="mt-8 pt-4" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <Link href="/browse" className="block rounded-lg px-3 py-2 text-sm text-white/25 hover:text-white/50">Browse {"{{CONTENT_NOUN_PLURAL}}"}</Link>
        </div>
