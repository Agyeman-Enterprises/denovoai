...
Your job ends at: all payment flows work, app runs on port 4014,
...
# App
NEXT_PUBLIC_APP_URL=http://localhost:4014
```
...
```bash
stripe listen --forward-to localhost:4014/api/stripe/webhook
```
...
- Domain: `https://stripe-test.agyemanenterprises.com`
...
7. Port running on: must be **4014**
